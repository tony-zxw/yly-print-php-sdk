...
namespace YLYPlatform\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('YLYPlatform', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir() . '/ylyplatform/ylyplatform.log',
    ...
    {
        return $config['name'] ?? 'YLYPlatform';
    }
