...
namespace YLYPlatform\ClientMode\PrinterServices;
...
class Client extends BaseClient
{
     ...
     * @return mixed
     */
    public function addPrinter(string $machineCode, string $mSign, string $printName = '', string $phone = '')
    {
        $params = [
        ...
        return $this->httpPostJson('printer/addprinter', $params);
    }
    ...
    {
        return $this->httpPostJson('printer/deletevoice', array('machine_code' => $machineCode, 'aid' => $aid));
    }
    ...
    {
        return $this->httpPostJson('printer/deleteprinter', array('machine_code' => $machineCode));
    }
    ...
    {
        return $this->httpPostJson('printer/shutdownrestart', array('machine_code' => $machineCode, 'response_type' => $responseType));
    }
    ...
    {
        return $this->httpPostJson('printer/setsound', array('machine_code' => $machineCode, 'voice' => $voice, 'response_type' => $responseType));
    }
    ...
    {
        return $this->httpPostJson('printer/printinfo', array('machine_code' => $machineCode));
    }
    ...
    {
        return $this->httpPostJson('printer/getversion', array('machine_code' => $machineCode));
    }
    ...
    {
        return $this->httpPostJson('printer/cancelall', array('machine_code' => $machineCode));
    }
    ...
    {
        return $this->httpPostJson('printer/cancelone', array('machine_code' => $machineCode, 'order_id' => $orderId));
    }
    ...
    {
        return $this->httpPostJson('printer/seticon', array('machine_code' => $machineCode, 'img_url' => $imgUrl));
    }
    ...
    {
        return $this->httpPostJson('printer/deleteicon', array('machine_code' => $machineCode));
    }
    ...
    {
        return $this->httpPostJson('printer/btnprint', array('machine_code' => $machineCode, 'response_type' => $responseType));
    }
    ...
    {
        return $this->httpPostJson('printer/getorder', array('machine_code' => $machineCode, 'response_type' => $responseType));
    }
    ...
    {
        return $this->httpPostJson('printer/getorderstatus', array('machine_code' => $machineCode, 'order_id' => $orderId));
    }
